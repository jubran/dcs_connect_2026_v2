import{r as N,U as w,V as z,X as o,j as v,Y as k,a7 as E,Z as c,$ as U,b5 as F,aC as D,aD as R}from"./index-BuTbhSY4.js";const I=["className","color","disableShrink","size","style","thickness","value","variant"];let l=r=>r,P,b,$,S;const a=44,K=R(P||(P=l`
  0% {
...
`)),W=r=>{const{classes:s,variant:e,color:t,disableShrink:d}=r,u={root:["root",e,`color${c(t)}`],svg:["svg"],circle:["circle",`circle${c(e)}`,d&&"circleDisableShrink"]};return U(u,F,s)},Z=k("span",{name:"MuiCircularProgress",slot:"Root",overridesResolver:(r,s)=>{const{ownerState:e}=r;return[s.root,s[e.variant],s[`color${c(e.color)}`]]}})(({ownerState:r,theme:s})=>o({display:"inline-block"},r.variant==="determinate"&&{transition:s.transitions.create("transform")},r.color!=="inherit"&&{color:(s.vars||s).palette[r.color].main}),({ownerState:r})=>r.variant==="indeterminate"&&D($||($=l`
    ...
    `),V)),X=N.forwardRef(function(s,e){const t=w({props:s,name:"MuiCircularProgress"}),{className:d,color:u="primary",disableShrink:_=!1,size:p=40,style:j,thickness:i=3.6,value:f=0,variant:x="indeterminate"}=t,M=z(t,I),n=o({},t,{color:u,disableShrink:_,size:p,thickness:i,value:f,variant:x}),h=W(n),m={},g={},C={};if(x==="determinate"){const y=2*Math.PI*((a-i)/2);m.strokeDasharray=y.toFixed(3),C["aria-valuenow"]=Math.round(f),m.strokeDashoffset=`${((100-f)/100*y).toFixed(3)}px`,g.transform="rotate(-90deg)"}return v.jsx(Z,o({className:E(h.root,d),style:o({width:p,height:p},g,j),ownerState:n,ref:e,role:"progressbar"},C,M,{children:v.jsx(B,{className:h.svg,ownerState:n,viewBox:`${a/2} ${a/2} ${a} ${a}`,children:v.jsx(G,{className:h.circle,style:m,ownerState:n,cx:a,cy:a,r:(a-i)/2,fill:"none",strokeWidth:i})})}))});export{X as C};
