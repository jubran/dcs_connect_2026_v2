...
import SequenceManagerView from "../components/SequenceManager.view.index"; // استدعاء المكون الرئيسي
import { useSequenceApi } from "src/myApp/Dynamic-Sequence/hooks/useSequenceApi";
import { useDragAndDrop } from "src/myApp/Dynamic-Sequence/hooks/useDragAndDrop";
import { useSequenceSelectors } from "../hooks/useSequenceSelectors";
import { normalizeSequenceData } from "../utils/SequenceManager.normalizer";
