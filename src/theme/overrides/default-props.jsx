...
export function defaultProps(theme) {
  return {
    ...
    MuiChip: {
      defaultProps: {
        deleteIcon: <SvgColor src="/assets/icons/components/ic_close.svg" />,
      },
    },
    MuiDialogActions: {
      defaultProps: {
    ...
    MuiDataGrid: {
      defaultProps: {
        slots: {
          ...
          columnMenuIcon: () => (
            <SvgColor width={20} src="/assets/icons/components/ic_more.svg" />
          ),
          ...
          columnMenuFilterIcon: () => (
            <SvgColor width={20} src="/assets/icons/components/ic_filter.svg" />
          ),
          columnMenuHideIcon: () => (
            <SvgColor
              width={20}
              src="/assets/icons/components/ic_eye_closed.svg"
            />
          ),
          columnMenuManageColumnsIcon: () => (
            <SvgColor width={20} src="/assets/icons/components/ic_eye.svg" />
          ),
          columnSelectorIcon: () => (
            <SvgColor width={20} src="/assets/icons/components/ic_eye.svg" />
          ),
          ...
          filterPanelDeleteIcon: () => (
            <SvgColor width={20} src="/assets/icons/components/ic_close.svg" />
          ),
          ...
          // export
          exportIcon: () => (
            <SvgColor width={20} src="/assets/icons/components/ic_export.svg" />
          ),
          // quick filter
          quickFilterIcon: () => (
            <SvgColor
